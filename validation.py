...
model.load_state_dict(torch.load('/home/lijw/BirdCLEF/BirdCLEF-Baselinev2/logs/2023-05-22T12:28-seresnext-alldata-mel128/saved_model.pt'))
...
for idx,(audios,labels) in enumerate(valloader):
    ...
    with torch.no_grad():
        ...
        pred = (model.forward(images)['maxframewise_output']+model.forward(images)['clipwise_output'])/2
