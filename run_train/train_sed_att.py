...
from utils import *
from losses import SmoothBCEFocalLoss
import  audiomentations as AA
from torchtoolbox.tools import cutmix_data,MixingDataController,mixup_data
...
# pretrianed_dict = torch.load('/root/projects/BirdClef2025/BirdCLEF2023-30th-place-solution-master/logs/2025-03-18T17:31-pretrain/saved_model.pt')
...
for i in range(CFG.epochs):
    ...
    logging.info('epoch:[{}/{}]  cmAP:{:.4f}'.format(i,CFG.epochs,cmAP_pad5_score))
