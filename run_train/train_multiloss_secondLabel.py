...
from model import BirdClefModel,BirdClefSEDModel,BirdClefSEDAttModel,BirdSetSEDModel
...
df_valid['path'] = CFG.data_root+df_train['filename']
...
model = BirdSetSEDModel(CFG.num_classes).cuda()

# optimzer
if CFG.finetune_weight == True:
    model_dict = model.state_dict()
    pretrianed_dict = torch.load('/root/projects/BirdClef2025/BirdCLEF2023-30th-place-solution-master/logs/2025-03-29T16:29-pretrain/saved_model_lastepoch.pt')
