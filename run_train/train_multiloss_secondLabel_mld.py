...
from model import BirdClefModel,BirdClefSEDModel,BirdClefSEDAttModel,TeacherModel
...
from utils import *
from losses import SmoothBCEFocalLoss,MultiLoss,MultiLossWeighting,BCELoss,MLDLoss,RKdAngle,RkdDistance
...
df_valid['is_pesudo'] = 0
df_train['is_pesudo'] = 0
...
train_set = BirdDatasetWithPseudoLabel(df_train,bird_cols=birds,sr = CFG.sample_rate,duration = CFG.duration,train = True,audio_augmentations=wav_transform)
val_set = BirdDatasetWithPseudoLabel(df_valid,bird_cols=birds,sr = CFG.sample_rate,duration = CFG.infer_duration,train = False)
