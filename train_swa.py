...
loss_ = MultiLoss(smoothing=CFG.smoothing_factor)
...
swa_scheduler = SWALR(optimizer,swa_lr=CFG.lr/50)
swa_start = 30

scheduler = fetch_scheduler(optimizer,len(trainloader),epochs=swa_start)
...
update_bn(trainloader, swa_model, model)
torch.save(swa_model.state_dict(),'/home/lijw/BirdCLEF/BirdCLEF-Baselinev2/logs/'+current_time+'/saved_model_lastepoch.pt')
